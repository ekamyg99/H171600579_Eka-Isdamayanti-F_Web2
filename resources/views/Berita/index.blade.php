    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <a href="{!! route('berita.trash')!!}" class="btn btn-danger">{{ __('Berita yang telah di hapus')}}</a>
                    ...
                    <tbody>
                        @foreach ($Berita as $item)
                            <tr>
                                ...
                                <td>
                                <a href="{!! route('berita.show',[$item-> id]) !!}" button class="btn btn-sn  btn-success" >Lihat Detail</a>
